 ...
 */
public class SBeanFieldCalendarYear extends JSpinner implements SGuiFieldCalendar {
    ...
    public SBeanFieldCalendarYear() {
        msFieldName = "";
        mnDefaultValue = SLibTimeConsts.YEAR_MIN;
        mnMinInteger = SLibTimeConsts.YEAR_MIN;
        mnMaxInteger = SLibTimeConsts.YEAR_MAX;
        moNextField = null;
        moNextButton = null;
        moFormButton = null;
        mnTab = -1;
        ...
        setEditor(new JSpinner.NumberEditor(this, SLibUtils.DecimalFormatCalendarYear.toPattern()));
    ...
    public int getGuiType() {
        return SGuiConsts.GUI_TYPE_INT_CAL_YEAR;
    }
    ...
    @Override
    public void setNextField(SGuiField field) {
        moNextField = field;
    }
