...
public class SRedisLockKey {
    ...
    public SRedisLockKey(final String lockKey) {
        ...
        setLockKey(
                ...
                SLibUtils.parseInt(key[KEY_REGISTRY_TYPE_INDEX]),
                key[KEY_REGISTRY_PK_INDEX],
                SLibUtils.parseInt(key[KEY_SESSION_ID_INDEX]),
                SLibUtils.parseInt(key[KEY_USER_ID_INDEX])
        );

    }
    
    public SRedisLockKey(final long lockId, final int companyId, final int registryType, final String registryPk, final long sessionId, final int userId) {
